...
(function (window, document, $) {
  ...
  $(window).on('load', function () {
    ...
    if (
      $(
        'body.horizontal-layout.vertical-overlay-menu.layout-dark:not(.layout-transparent)',
      ).length > 0
    ) {
  ...
  $(document).on(
    'click',
    '.nav-toggle, .menu-toggle, .nav-close',
    function (e) {
      e.preventDefault();
  ...
  $('.dropdown-language + .dropdown-menu .dropdown-item').on(
    'click',
    function () {
      var $this = $(this);
  ...
  $('.navbar-container .scrollable-container .custom-switch span').on(
    'click',
    function (e) {
      e.stopPropagation();
    },
